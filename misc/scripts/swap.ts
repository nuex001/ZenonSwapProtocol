...
async function approveTokens (base: MockERC20, quote: MockERC20, dex: ZenonSwapDex) {
...
async function swap (dex: ZenonSwapDex, base: MockERC20, quote: MockERC20) {
...
async function main() {
    ...
    let dex = factory.attach("0x141E224f461a85006b2EF051a7C1c290E449202A") as ZenonSwapDex
